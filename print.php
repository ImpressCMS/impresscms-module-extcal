...
if(!$event['event_isrecur']) {
	echo '<b>'._MD_ICALENDAR_START.' :</b> <span style="font-weight:normal;">'.$event['formated_event_start'].'</span><br />'."\n";
	echo '<b>'._MD_ICALENDAR_END.' :</b> <span style="font-weight:normal;">'.$event['formated_event_end'].'</span>'."\n";
} else {
	echo '<b>'._MD_ICALENDAR_RECCUR_RULE.' :</b> <span style="font-weight:normal;">'.$event['formated_reccur_rule'].'</span>'."\n";
}
echo '</td>'."\n";
echo '</tr>'."\n";
echo '<tr>'."\n";
echo '<td style="border:1px solid black;">'."\n";
echo '<b>'._MD_ICALENDAR_CONTACT_INFO.'</b><br />'."\n";
echo '<span style="font-weight:normal;">'.$event['event_contact'].'<br />'."\n";
echo $event['event_address'].'</span>'."\n";
echo '</td>'."\n";
echo '<td style="border:1px solid black;">'."\n";
echo '<b>'._MD_ICALENDAR_EMAIL.' :</b> <a href="mailto:'.$event['event_email'].'">'.$event['event_email'].'</a><br />'."\n";
echo '<b>'._MD_ICALENDAR_URL.' :</b> <a href="'.$event['event_url'].'">'.$event['event_url'].'</a>'."\n";
echo '</td>'."\n";
echo '</tr>'."\n";
echo '<tr>'."\n";
