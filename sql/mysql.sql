CREATE TABLE `icalendar_cat` (
  `cat_id` int(11) NOT NULL auto_increment,
  `cat_name` varchar(255) NOT NULL,
  `cat_desc` text NOT NULL,
  `cat_color` varchar(6) NOT NULL,
  PRIMARY KEY  (`cat_id`)
) COMMENT='iCalendar By Zoullou' ;

CREATE TABLE `icalendar_event` (
...
CREATE TABLE `icalendar_eventmember` (
...
CREATE TABLE `icalendar_eventnotmember` (
