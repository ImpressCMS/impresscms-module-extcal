...
$xoopsOption['template_main'] = 'icalendar_calendar-week.html';
...
$navig = array(
			'prev'=>array(
						...
						'name'=>$icalendarTimeHandler->getFormatedDate(icms::$module->config['nav_date_week'], $pWeekCalObj->getTimestamp())
			),
			'this'=>array(
						'uri'=>'year='.$weekCalObj->thisYear().'&amp;month='.$weekCalObj->thisMonth().'&amp;day='.$weekCalObj->thisDay(),
						'name'=>$icalendarTimeHandler->getFormatedDate(icms::$module->config['nav_date_week'], $weekCalObj->getTimestamp())
			),
			'next'=>array(
						'uri'=>'year='.$nWeekCalObj->thisYear().'&amp;month='.$nWeekCalObj->thisMonth().'&amp;day='.$nWeekCalObj->thisDay(),
						'name'=>$icalendarTimeHandler->getFormatedDate(icms::$module->config['nav_date_week'], $nWeekCalObj->getTimestamp())
			)
);
