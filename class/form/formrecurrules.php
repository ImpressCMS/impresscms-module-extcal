...
class ExtcalFormRecurRules extends icms_form_Element {
	...
	function render(){
		...
		$ret .= '<br /><br /><fieldset style="border: #e8e8e8 1px solid;"><legend>'._MD_EXTCAL_RECCUR_POLICY.'</legend><fieldset style="border: #e8e8e8 1px solid;"><legend>';
		...
		$ret .= $formObject->render();
		$ret .=' '._MD_EXTCAL_DAYS.'</fieldset><br /><fieldset style="border: #e8e8e8 1px solid;"><legend>';
		...
		$ret .= $formObject->render();
		$ret .=' '._MD_EXTCAL_DAY_NUM_MONTH.'</fieldset><br /><fieldset style="border: #e8e8e8 1px solid;"><legend>';
