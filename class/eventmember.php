...
class IcalendarEventmember extends icms_core_Object {

	function IcalendarEventmember()
	{
...
class IcalendarEventmemberHandler extends IcalendarPersistableObjectHandler
{
	function IcalendarEventmemberHandler(&$db) {
		$this->IcalendarPersistableObjectHandler($db, 'icalendar_eventmember', 'IcalendarEventmember', array('event_id', 'uid'));
	}
