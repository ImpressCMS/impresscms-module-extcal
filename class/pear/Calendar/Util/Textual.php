...
if(file_exists(ICMS_ROOT_PATH."/language/".$icmsConfig['language']."/calendar.php")) {
	include_once ICMS_ROOT_PATH."/language/".$icmsConfig['language']."/calendar.php";
} else {
	include_once ICMS_ROOT_PATH."/language/english/calendar.php";
}
if(file_exists(ICMS_ROOT_PATH."/modules/extcal/language/".$icmsConfig['language']."/main.php")) {
	include_once ICMS_ROOT_PATH."/modules/extcal/language/".$icmsConfig['language']."/main.php";
} else {
	include_once ICMS_ROOT_PATH."/modules/extcal/language/english/main.php";
}
