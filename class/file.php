...
include_once ICMS_ROOT_PATH.'/modules/'.icms::$module->getVar('dirname').'/class/IcalendarPersistableObjectHandler.php';
include_once ICMS_ROOT_PATH.'/class/uploader.php';

class IcalendarFile extends icms_core_Object {

	function IcalendarFile()
	{
...
class IcalendarFileHandler extends IcalendarPersistableObjectHandler {

	function IcalendarFileHandler(&$db)
	{
		$this->IcalendarPersistableObjectHandler($db, 'icalendar_file', 'IcalendarFile', 'file_id');
	}
	...
	function _deleteFile(&$file) {
		if(file_exists(ICMS_ROOT_PATH.'/uploads/icalendar/'.$file->getVar('file_name')))
			unlink(ICMS_ROOT_PATH.'/uploads/icalendar/'.$file->getVar('file_name'));
	}
}
?>