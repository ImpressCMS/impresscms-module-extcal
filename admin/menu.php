...
$adminmenu[1]['title'] 	= _MI_ICALENDAR_INDEX;
...
$adminmenu[2]['title'] 	= _MI_ICALENDAR_CATEGORY;
...
$adminmenu[3]['title'] 	= _MI_ICALENDAR_EVENT;
...
$adminmenu[4]['title'] 	= _MI_ICALENDAR_PERMISSIONS;
...
//$adminmenu[5]['title'] 	= _MI_ICALENDAR_PRUNING;
...
if ( isset( icms::$module ) ) {
	...
	$i = -1;
	$i++;
	$headermenu[$i]['title'] = _AM_ICALENDAR_GO_TO_MODULE;
	...
	$i++;
	$headermenu[$i]['title'] = _AM_ICALENDAR_UPDATE;
