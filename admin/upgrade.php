...
switch($step) {
	...
	case 'download':
		...
		icms_core_Message::confirm(array('step' => 'install'), 'upgrade.php', _AM_EXTCAL_DOWN_DONE, _AM_EXTCAL_INSTALL);
	...
	case 'install':
		...
		icms_core_Message::confirm(array('dirname' => $localModuleDir, 'op' => 'update_ok', 'fct' => 'modulesadmin'), ICMS_URL.'/modules/system/admin.php', _AM_EXTCAL_INSTALL_DONE, _AM_EXTCAL_UPDATE);
